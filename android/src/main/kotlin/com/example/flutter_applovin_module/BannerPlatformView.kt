...
class BannerPlatformView(
    ...
    init {
        ...
        applovinDiscoveryAds.showBanner(activity, bannerView, sizeBanner, adUnitId, object : CallbackAds() {
...
class BannerPlatformViewFactory(
    ...
    override fun create(context: Context, viewId: Int, args: Any?): PlatformView {
        ...
        return BannerPlatformView(activity, context, applovinDiscoveryAds, sizeBanner, adUnitId, callbackChannel)
    }
}