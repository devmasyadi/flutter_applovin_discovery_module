...
class NativePlatformView(
    ...
    init {
        ...
        applovinDiscoveryAds.showNativeAds(activity, nativeView, sizeNative, adUnitId, object : CallbackAds() {
...
class NativePlatformViewFactory(
    ...
    override fun create(context: Context, viewId: Int, args: Any?): PlatformView {
        ...
        return NativePlatformView(activity, context, applovinDiscoveryAds, sizeNative, adUnitId, callbackChannel)
    }
}